...
step2 = pd.merge(proof, trade, how='inner', left_on='receiver_trade_id', right_on='id')
step2 = pd.merge(top, step2, how='inner', left_on='trade_id', right_on='receiver_trade_id')
...
print(result)
result.to_json('stick_top_2.json', orient='split')
result.to_csv('stick_top_2.csv')
