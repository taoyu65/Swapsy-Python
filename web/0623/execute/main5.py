...
variable_2001 = 1594921024   # 发送邮件的时间戳
variable_2002 = 1597179095

variable = variable_2001

trans = pd.read_csv("../db/credit_transaction 2020-07-05.csv", low_memory=False)
trans_part = pd.read_csv("../db/credit_transaction 2020-07-05 to 2020-09-07.csv", low_memory=False)
