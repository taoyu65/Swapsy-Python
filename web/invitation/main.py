...
inviter = pd.read_csv("../../db/new/invitation_user_2021-12-31.csv", low_memory=False)
nmi = pd.read_csv("../../db/new/credit_nmi_transaction_2021-12-31.csv", low_memory=False)
manual = pd.read_csv("../../db/new/credit_payment_2021-12-31.csv", low_memory=False)
redeem = pd.read_csv("../../db/new/invitation_redeem_2021-12-31.csv", low_memory=False)
